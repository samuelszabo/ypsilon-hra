...
export default class extends Controller {
    ...
    endGame() {
        ...
        this.resultTarget.innerHTML = '<div class="pb-1 pb-md-4">' + resultText + '</div><div class="pb-1 pb-md-4">' + this.resultTable() + '</div><br><button onclick="location.reload()" class="mt-1 mt-md-4 btn btn-primary btn-lg">Hraj opäť</button>';
